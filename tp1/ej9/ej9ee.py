...
class ej9ee(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "ej9ee")
        ...
        self.analog_sig_source_x_1 = analog.sig_source_f(samp_rate, analog.GR_SIN_WAVE, 100, 1, 0, 0)
        ...
        self.connect((self.blocks_throttle2_0, 0), (self.channels_quantizer_0, 0))
...
def main(top_block_cls=ej9ee, options=None):
