...
import ej9f2_epy_block_0 as epy_block_0  # embedded python block
import sip
import threading



class ej9f2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "ej9f2")
...
def main(top_block_cls=ej9f2, options=None):
