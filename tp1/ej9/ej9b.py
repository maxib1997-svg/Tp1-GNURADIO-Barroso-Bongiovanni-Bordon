...
class ej9b(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "ej9b")
        ...
        self.connect((self.channels_quantizer_0, 0), (self.qtgui_time_sink_x_0, 0))
...
def main(top_block_cls=ej9b, options=None):
