...
class ej9e(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "ej9e")
        ...
        self.blocks_multiply_const_vxx_1 = blocks.multiply_const_cc(2/3)
        self.blocks_multiply_const_vxx_0 = blocks.multiply_const_cc(1.5)
        self.blocks_add_const_vxx_0 = blocks.add_const_cc(0.5)
        self.analog_sig_source_x_0 = analog.sig_source_c(10000, analog.GR_COS_WAVE, 100, 1, 0, 0)
...
def main(top_block_cls=ej9e, options=None):
