...
class ej7(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "ej7")
        ...
        self.blocks_wavfile_source_0 = blocks.wavfile_source('F:\\gnuradio\\tp1\\guia1_sys2_gnuradio_archivos_2025\\guitar.wav', True)
...
def main(top_block_cls=ej7, options=None):
