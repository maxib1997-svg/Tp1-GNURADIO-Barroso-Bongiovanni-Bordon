...
class ej5(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "ej5")
        ...
        self.analog_sig_source_x_0.set_block_alias("x(t) = e^{j2π1000t}")
        ...
        self.connect((self.blocks_complex_to_magphase_0, 0), (self.qtgui_time_sink_x_2, 0))
        self.connect((self.blocks_complex_to_magphase_0, 1), (self.qtgui_time_sink_x_3, 0))
...
def main(top_block_cls=ej5, options=None):
